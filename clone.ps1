...
$sourceReportGroupId = "Fill me"    # the ID of the group (workspace) that hosts the source report. Use "me" if this is your My Workspace
$sourceReportId = "fill me"         # the ID of the source report
...
$targetReportName = "Fill me"       # what you'd like to name the target report
$targetGroupId = "Fill me"          # the ID of the group (workspace) that you'd like to move the report to. Leave this blank if you'd like to clone to the same workspace. Use "me" if this is your My Workspace
$targetDatasetId = "Fill me"        # the ID of the dataset that you'd like to rebind the target report to. Leave this blank to have the target report use the same dataset
